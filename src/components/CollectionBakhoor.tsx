...
const CollectionBakhoor = () => {
  ...
  const bakhoorCat = categories.find((c) => c.slug === 'bakhoor')
  const catId = bakhoorCat?.id
    ...
    <div className="shop-page">
      ...
      <header className="cp-hero">
        <div className="cp-hero-inner">
          ...
          <h1 className="cp-hero-title">Bakhoor</h1>
          <p className="cp-hero-sub">Traditional Luxury — handcrafted bakhoor for your home</p>
        </div>
      </header>
      ...
      <main className="cp-main">
        ...
        {!loading && products.length === 0 && (
          <p className="cp-empty">No bakhoor products found.</p>
        )}
